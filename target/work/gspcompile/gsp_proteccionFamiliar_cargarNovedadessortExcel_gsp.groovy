...
class gsp_proteccionFamiliar_cargarNovedadessortExcel_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cargarNovedades/sortExcel.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('javascript','asset',10,['src':("cargarNovedades/sortExcel.js")],-1)
printHtmlPart(3)
})
