...
class gsp_proteccionFamiliar_gestionNovedadesindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/gestionNovedades/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('sortableColumn','g',31,['property':("descripcion"),'title':(message(code: 'gestion.descripcion.label', default: 'Identificacion'))],-1)
printHtmlPart(7)
...
public static final long LAST_MODIFIED = 1629211647029L
