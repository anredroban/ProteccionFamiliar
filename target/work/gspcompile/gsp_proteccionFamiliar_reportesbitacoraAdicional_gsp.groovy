...
class gsp_proteccionFamiliar_reportesbitacoraAdicional_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraAdicional.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',21,['action':("bitacoraAdicional"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
