...
class gsp_proteccionFamiliar_motivosnoaceptaedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/motivosnoacepta/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'motivosnoacepta.label', default: 'Motivosnoacepta'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(motivosnoaceptaInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',28,['bean':(motivosnoaceptaInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(motivosnoaceptaInstance?.version)],-1)
printHtmlPart(19)
...
invokeTag('form','g',37,['url':([resource:motivosnoaceptaInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(22)
})
