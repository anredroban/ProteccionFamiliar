...
class gsp_proteccionFamiliar_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',8,['default':("Plus CRM")],-1)
})
...
printHtmlPart(1)
invokeTag('javascript','asset',16,['src':("customdatatables.js")],-1)
printHtmlPart(1)
...
createTagBody(1, {->
printHtmlPart(10)
invokeTag('hiddenField','g',39,['id':("extension"),'name':("extension"),'value':(Util.getExtension(session.user.usuario))],-1)
printHtmlPart(11)
...
invokeTag('link','g',57,['action':("logout"),'controller':("usuario")],3)
printHtmlPart(17)
...
printHtmlPart(20)
invokeTag('render','g',73,['template':("/layouts/sidebar")],-1)
printHtmlPart(21)
invokeTag('layoutBody','g',77,[:],-1)
printHtmlPart(22)
invokeTag('render','g',85,['template':("/layouts/operatorbar")],-1)
printHtmlPart(23)
invokeTag('javascript','asset',107,['src':("main/bootstrap.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',108,['src':("telephony/operatorbar.js")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',108,['src':("telephony/asteriskAmi.js")],-1)
printHtmlPart(24)
})
