...
class gsp_proteccionFamiliar_subestadoedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/subestado/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'subestado.label', default: 'Subestado'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(subestadoInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',28,['bean':(subestadoInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(subestadoInstance?.version)],-1)
printHtmlPart(19)
...
invokeTag('form','g',37,['url':([resource:subestadoInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(22)
})
