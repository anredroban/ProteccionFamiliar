...
class gsp_proteccionFamiliar_asignarNovedadesindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/asignarNovedades/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('javascript','asset',5,['src':("asignarNovedades/index.js")],-1)
printHtmlPart(1)
createTagBody(2, {->
...
invokeTag('select','g',79,['class':("form-control"),'name':("dbName"),'id':("dbName"),'required':("true"),'from':(utilitarios.Util.getNombresBaseNovedades()),'noSelection':(['': '-Seleccione-'])],3)
printHtmlPart(12)
createClosureForHtmlPart(11, 3)
...
invokeTag('form','g',124,['controller':("asignarNovedades"),'action':("index")],2)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1628261213694L
