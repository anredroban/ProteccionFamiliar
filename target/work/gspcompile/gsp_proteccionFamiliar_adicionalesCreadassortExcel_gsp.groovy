...
class gsp_proteccionFamiliar_adicionalesCreadassortExcel_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/adicionalesCreadas/sortExcel.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('javascript','asset',10,['src':("adicionalesCreadas/sortExcel.js")],-1)
printHtmlPart(3)
})
...
for( i in (formFields) ) {
printHtmlPart(7)
invokeTag('select','g',28,['name':(i),'noSelection':(['':'-Seleccione-']),'from':(headers)],-1)
printHtmlPart(8)
expressionOut.print(i)
printHtmlPart(9)
}
printHtmlPart(10)
invokeTag('textField','g',38,['id':("dbName"),'name':("dbName")],-1)
printHtmlPart(11)
expressionOut.print(filePath)
printHtmlPart(12)
invokeTag('render','g',47,['template':("/layouts/completeMessage")],-1)
printHtmlPart(13)
})
