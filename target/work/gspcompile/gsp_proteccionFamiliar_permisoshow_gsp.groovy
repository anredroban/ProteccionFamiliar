...
class gsp_proteccionFamiliar_permisoshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/permiso/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('fieldValue','g',29,['bean':(permisoInstance),'field':("descripcion")],-1)
printHtmlPart(11)
invokeTag('fieldValue','g',38,['bean':(permisoInstance),'field':("descripcion")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',54,['class':("edit"),'action':("edit"),'resource':(permisoInstance)],3)
printHtmlPart(14)
...
invokeTag('form','g',55,['url':([resource:permisoInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(16)
})
