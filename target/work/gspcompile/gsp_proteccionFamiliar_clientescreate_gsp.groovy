...
class gsp_proteccionFamiliar_clientescreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/clientes/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'clientes.label', default: 'Clientes'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(cliente),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',26,['bean':(cliente)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
...
invokeTag('form','g',34,['url':([resource:cliente, action:'save'])],2)
printHtmlPart(20)
})
