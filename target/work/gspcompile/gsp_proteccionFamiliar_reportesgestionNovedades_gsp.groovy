...
class gsp_proteccionFamiliar_reportesgestionNovedades_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/gestionNovedades.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',26,['action':("gestionNovedades"),'class':("col-lg-12")],1)
printHtmlPart(5)
}
