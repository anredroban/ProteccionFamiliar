...
class gsp_proteccionFamiliar_usuarioedit_gsp extends GroovyPage {
...
invokeTag('hasErrors','g',25,['bean':(usuarioInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(16)
invokeTag('hiddenField','g',29,['name':("version"),'value':(usuarioInstance?.version)],-1)
printHtmlPart(17)
...
invokeTag('form','g',47,['url':([resource:usuarioInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(20)
})
