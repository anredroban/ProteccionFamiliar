...
class gsp_proteccionFamiliar_reportesbitacoraNovedades_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraNovedades.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('select','g',21,['class':("form-control"),'name':("nombreBase"),'multiple':("true"),'size':("25"),'required':(""),'from':(utilitarios.Util.getNombresBaseNovedades())],-1)
printHtmlPart(3)
invokeTag('submitButton','g',24,['name':("btnEnviar"),'value':("Enviar")],-1)
printHtmlPart(4)
})
invokeTag('form','g',26,['action':("bitacoraNovedades"),'class':("col-lg-12")],1)
printHtmlPart(5)
}
