...
class gsp_proteccionFamiliar_reportesventas_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/ventas.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('submitButton','g',21,['class':("btn btn-success"),'style':("height: 40px; width: 170px; font-weight: bold; font-family: 'Myriad Pro'; font-size: 16px"),'name':("btnEnviar"),'value':("Enviar")],-1)
printHtmlPart(3)
})
invokeTag('form','g',21,['action':("ventas"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1628261213719L
