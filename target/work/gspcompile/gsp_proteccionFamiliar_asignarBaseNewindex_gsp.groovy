...
class gsp_proteccionFamiliar_asignarBaseNewindex_gsp extends GroovyPage {
...
printHtmlPart(12)
createClosureForHtmlPart(11, 3)
invokeTag('select','g',88,['class':("form-control"),'name':("tipoRegx"),'id':("tipoRegx"),'required':("true"),'from':(['SIN GESTION', 'REGESTIONABLES', 'RELLAMADAS']),'noSelection':(['': '-Seleccione-'])],3)
printHtmlPart(13)
createClosureForHtmlPart(11, 3)
invokeTag('select','g',97,['class':("form-control"),'name':("subestadosRegestionables"),'id':("subestadosRegestionables"),'from':(utilitarios.Util.getSubestadosRegestionables()),'noSelection':(['': '-Seleccione-']),'optionKey':("nombre"),'optionValue':({it.nombre})],3)
printHtmlPart(14)
...
public static final long LAST_MODIFIED = 1629158420243L
