    ...
    def index() {
        ...
        if (params.consultants && params.dbName && params.tipoRegx && params.allocationNumber) {
            ...
            if(tipoRegistros.equalsIgnoreCase("SIN GESTION")){
                ...
                sql = "from ClientesNovedades where subestadoGestion.type = 'Regestionable' and usuario.rol != :rol and nombreBase = :nombreBase and intentos != 0 ${condicionEasyDesde} ${condicionEasyHasta} ${condicionIntentosDesde} ${condicionIntentosHasta}  ${condicionSubestado} order by intentos"
            }
