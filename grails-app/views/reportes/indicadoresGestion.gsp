        ...
        <div id="dvData">
            <table class="table table-bordered table-hover table-striped">
                ...
                <g:each in="${tablaResult}">
                    <tr>
                        <td>${it[10]?:0}</td><td>${it[0]}</td><td>${it[1]}</td><td>${it[2]?:0}</td><td>${it[7]?:0}</td><td>${it[6]?:0}</td><td>${it[4]?:0}</td><td>${it[5]?:0}</td><td>${it[11]?:0}</td><%----%><td>${it[9]?:0}</td><td>${it[8]?:0}</td><td>${it[3]?:0}</td><%--<td>${it[11]?:0}</td>--%>
                    </tr>
                </g:each>
                <tr style="color: blue; background-color: #D3D3D3;">
                    <td></td><td><strong>TOTAL</strong></td><td><strong>${totalGestionados}</strong></td><td><strong>${totalContactados}</strong></td><td><strong>${totalNoDeseaCU5}</strong></td><td><strong>${totalCruzadasCU3}</strong></td><td><strong>${totalExitosos}</strong></td><td><strong>${totalCruzadasCU2}</strong></td>
                    <td><strong>${totalAdicionales}</strong></td><td><strong>${totalPorcentajeEfectividad}</strong></td><td><strong>${totalPorcentajeContactabilidad}</strong></td><td><strong>${totalPorcentajeEfectividadPdp}</strong></td><%--<td><strong>${totalPorcentajeEfectividadCredito}</strong></td>--%>
                </tr>
                </tbody>
            </table>
        </div>
