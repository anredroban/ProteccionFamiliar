...
<div class="container-fluid">
    <g:form action = "ventas" class="col-lg-12">
        ...
        <div class="col-lg-12">
            <g:submitButton class="btn btn-success" style="height: 40px; width: 170px; font-weight: bold; font-family: 'Myriad Pro'; font-size: 16px" name = "btnEnviar" value = "Enviar"></g:submitButton>
        </div>
    </g:form>
</div>