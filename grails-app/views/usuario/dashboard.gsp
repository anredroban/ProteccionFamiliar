...
<html>
	<head>
		...
		<title>Proteccion Familiar - Dashboard</title>
...
<%--				CUADROS PARA QUITO--%>
           ...
           <%-- <a href="${createLink(uri:'#')}">
                    ...
                    <div class="panel panel-brown">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${Util.getCantidadVentasMes()}</div>
                                    <div>¡Exitosos acumulado!</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <a href="${createLink(uri:'#')}">
                <div class="col-lg-4 col-md-6 col-xs-12 cuadro">
                    <div class="panel panel-brown">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
...
<%--                Grafico de barras--%>
                ...
                <div class="panel panel-border-blue-u">
                    <div class="panel-heading panel-body-blue-u">
                        <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> Ventas por Marca</h3>
                        <a class="btn btn-blue-u btn-clickable pull-right" onclick="return false;" href="#">
                            <i class="fa fa-chevron-down"></i>
                        </a>
                    </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <g:each in="${tablaResult}">
                                            	<tr>
                                            		<td>${it[0]}</td><td>${it[1]}</td><td>${it[2]?:0}</td><%--<td>${it[3]?:0}</td>--%><td>${it[4]?:0}</td><td>${it[5]?:0}</td><%--<td>${it[8]?:0}</td>--%><td>${it[6]?:0}</td><td>${it[7]?:0}</td><%--<td>${it[8]?:0}</td>--%>
                                            	</tr>
                                            </g:each>
                                            <tr style="color: blue; background-color: #D3D3D3;">
                                            	<td><strong>TOTAL</strong></td><td><strong>${totalGestionados}</strong></td><td><strong>${totalContactados}</strong></td><%--<td><strong>${totalPorcentajeContactabilidad}</strong></td>--%><td><strong>${totalExitosos}</strong></td><td><strong>${totalAdicionales}</strong></td><%--<td><strong>${totalEncuestas}</strong></td>--%><td><strong>${totalPorcentajeEfectividad}</strong></td><td><strong>${totalColocacionPorCliente}</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-border-lila">
                        <div class="panel-heading panel-body-lila">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Ventas Diarias de Seguros</h3>
                            <a class="btn btn-orange btn-clickable pull-right" onclick="return false;" href="#">
                                <i class="fa fa-chevron-down"></i>
                            </a>
                        </div>
