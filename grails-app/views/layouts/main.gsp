...
<head>
	...
	<title><g:layoutTitle default="Plus CRM" /></title>
	...
	<asset:javascript src="customdatatables.js" />
...
<g:hiddenField id="extension" name="extension" value="${Util.getExtension(session.user.usuario)}" />
		...
		<nav class="navbar navbar-fixed-top" role="navigation">
			...
			<ul class="nav navbar-right box-user">
				<g:if test="${session.user}">
					...
					<%--<li>
						<g:link class="btn btn-warning" action="logout" controller="usuario">
